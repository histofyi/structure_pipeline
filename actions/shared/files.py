...
def build_structure_filename(pdb_code:str, assembly_id:str, format:str) -> str:
    """
    This function builds the standard filename for a structure e.g. 1hhk_1.pdb
    
    Args:

        pdb_code (str): the pdb code for the structure e.g. 1hhk
        assembly_id (str): the assembly id for the specific assembly e.g. 1
        format (str): the format of the structure e.g. .pdb
    
    Returns:
        str: the filename
    """
    return f"{pdb_code}_{assembly_id}.{format}"
